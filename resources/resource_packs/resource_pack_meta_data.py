    ...
    def _load(self, path):
        ...
        try:
            with open(path, "r", encoding="utf-8") as file:
                ...
                self.preview_image = TextureHandle(data["preview_image"]) if "preview_image" in data else None
            ...
            raise ResourcePackLoadError(f"Cannot read {path}. It may be damaged.")
        except Exception as error:
            raise ResourcePackLoadError(f"Unexpected error while loading {path}: {error}.")
